...
/**
 * Block edit form for block_nice_about_us_2.
 *
...
class block_nice_about_us_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_about_us_2')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_about_us_2'),
            1 => get_string('right', 'block_nice_about_us_2'),
            2 => get_string('center', 'block_nice_about_us_2'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_about_us_2'),
            $titleplacementoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_about_us_2')
        );
        ...
        // Add a text input element to the form for configuring the block video URL.
        // The label for this element is fetched from the language file associated with your custom block.
        $mform->addElement(
            'text',
            'config_video_url',
            get_string('config_video_url', 'block_nice_about_us_2')
        );
        // Set a default value for the block video URL text input that you've just added.
        ...
        $mform->addElement(
            'text',
            'config_main_link',
            get_string('config_main_link', 'block_nice_about_us_2')
        );
        ...
        $mform->addElement(
            'filemanager',
            'config_image',
            get_string('config_image', 'block_nice_about_us_2'),
            null,
            [
                'subdirs' => 0,
    ...
    public function set_data($defaults) {
        ...
        file_prepare_draft_area(
            ...
            'block_nice_about_us_2', // The component name.
