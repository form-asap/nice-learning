...
/**
 * Class definition for the block_nice_about_us_2.
 *
 * @package     block_nice_about_us_2
 * @copyright   2025 Nice Learning <support@docs.nicelearning.org>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_about_us_2 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_about_us_2');
    }
    ...
    public function specialization(): void {
        ...
        if (empty($this->config)) {
            ...
            $this->config->main_description =
                'In an ever-evolving world, learning stands as the beacon that guides '
                . 'individuals towards personal and professional growth. It is not merely '
                . 'the absorption of facts, but the cultivation of a mindset that is curious, '
                . 'adaptable, and open to new experiences. Whether we are diving deep into '
                . 'academic subjects or picking up life skills, the process of learning enriches '
                . 'our understanding, broadens our horizons, and equips us with tools to navigate '
                . 'the challenges and opportunities life presents.';

            $this->config->youtube_url = 'https://www.youtube.com/watch?v=PkZNo7MFNFg';

            $this->config->default_image = $CFG->wwwroot
                . '/theme/nice/pix/blocks/aboutus/nice_about_us_2.jpg';
        }
    }
    ...
    public function get_content(): stdClass {
        ...
        $iframe = $embedurl
            ? '<iframe class="rounded" title="Youtube video" src="' . htmlspecialchars($embedurl) . '" '
        ...
        $readmoretext = get_string('config_read_more', 'block_nice_about_us_2');
        ...
        $text = '
            <section class="nice-about-us-2 position-relative z-1">
                ...
                <div class="nice-about-us-container">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="nice-about-us-video-container">
