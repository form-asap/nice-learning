...
/**
 * Block edit form for block_nice_courses_slider_2.
 *
...
class block_nice_courses_slider_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_courses_slider_2')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_courses_slider_2'),
            1 => get_string('right', 'block_nice_courses_slider_2'),
            2 => get_string('center', 'block_nice_courses_slider_2'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_courses_slider_2'),
            $titleplacementoptions
        );
        $mform->setDefault('config_title_placement', 0);

        // Add a textarea element for configuring the block main description.
        // The label for this element is fetched from the language file associated with the custom block.
        $mform->addElement(
            'textarea',
            'config_main_description',
            get_string('config_main_description', 'block_nice_courses_slider_2')
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_shortname', 'block_nice_courses_slider_2'),
            $showshortnameoptions
        );
        ...
        $mform->addElement(
            'text',
            'config_link',
            get_string('config_link', 'block_nice_courses_slider_2')
        );
        ...
        $options = [
            'multiple' => true,
            'noselectionstring' => get_string('select_courses', 'block_nice_courses_slider_2'),
        ];
        $mform->addElement(
            'course',
            'config_courses',
