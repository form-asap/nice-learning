...
/**
 * Block edit form for block_nice_blogs_slider_2.
 *
...
class block_nice_blogs_slider_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_blogs_slider_2')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_blogs_slider_2'),
            1 => get_string('right', 'block_nice_blogs_slider_2'),
            2 => get_string('center', 'block_nice_blogs_slider_2'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_blogs_slider_2'),
            $titleplacementoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_blogs_slider_2')
        );
        ...
        $mform->addElement(
            'select',
            'config_show_date',
            get_string('config_show_date', 'block_nice_blogs_slider_2'),
            $showdateoptions
        );
        ...
        $mform->addElement(
            'select',
            'config_show_user',
            get_string('config_show_user', 'block_nice_blogs_slider_2'),
            $showuseroptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_description', 'block_nice_blogs_slider_2'),
            $showdescriptionoptions
        );
        ...
        $mform->addElement(
            'text',
            'config_link',
            get_string('config_link', 'block_nice_blogs_slider_2')
        );
