...
/**
 * Block edit form for block_nice_about_us_4.
 *
...
class block_nice_about_us_4_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_about_us_4')
        );
        ...
        // Add a textarea input field for the main description.
        $mform->addElement(
            'textarea',
            'config_main_description',
            get_string('config_main_description', 'block_nice_about_us_4')
        );
        // Define the data type for main description as textarea.
        $mform->setType('config_main_description', PARAM_TEXT);

        // Add a dropdown (select element) for "Title placement".
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_about_us_4'),
            1 => get_string('right', 'block_nice_about_us_4'),
            2 => get_string('center', 'block_nice_about_us_4'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_about_us_4'),
            $titleplacementoptions
        );
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            $mform->addElement(
                'header',
                'config_item' . $i,
                get_string('config_item', 'block_nice_about_us_4') . $i
            );
            ...
            $mform->addElement(
                'text',
                'config_title' . $i,
                get_string('config_title', 'block_nice_about_us_4', $i)
            );
            ...
            $mform->addElement(
                ...
                get_string('config_description', 'block_nice_about_us_4', $i)
            );
            ...
            $mform->addElement(
                'filemanager',
                'config_image' . $i,
                get_string('config_image', 'block_nice_about_us_4', $i),
                null,
                $filemanageroptions
            );
        }
