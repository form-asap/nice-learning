...
/**
 * Block edit form for block_nice_hero_3.
 *
...
class block_nice_hero_3_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_title',
            get_string('config_title', 'block_nice_hero_3')
        );
        $mform->setDefault(
            'config_title',
        ...
        // Add a textarea input element for the block description.
        $mform->addElement(
            'textarea',
            'config_description',
            get_string('config_description', 'block_nice_hero_3')
        );
        $mform->setDefault(
            'config_description',
            'Start learning from the world’s best institutions'
        ...
        // Add a filemanager element for uploading images.
        $mform->addElement(
            'filemanager',
            'config_image',
            get_string('config_image', 'block_nice_hero_3'),
            null,
            [
                'subdirs' => 0,
    ...
    public function set_data($defaults) {
        ...
        file_prepare_draft_area(
            ...
            'block_nice_hero_3', // The component name.
