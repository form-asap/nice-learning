...
/**
 * Class definition for the block_nice_testimonials_slider_1.
 *
 * @package     block_nice_testimonials_slider_1
 * @copyright   2025 Nice Learning <support@docs.nicelearning.org>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_testimonials_slider_1 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_testimonials_slider_1');
    }
    ...
    public function specialization(): void {
        ...
        if (empty($this->config)) {
            ...
            $defaultdescription = [
                ...
                2 => "The attention to detail in this theme is unparalleled. Every feature feels tailor-made for our needs, "
                    . "providing an exceptional browsing experience for all users.",
                3 => "The flexibility and adaptability of this theme are astounding. It has infused our website with a fresh "
                    . "energy and vibrancy that we didn't know we were missing.",
    ...
    public function get_content(): stdClass {
        ...
        $this->content->text = '
<section class="nice-testimonials-slider-1">
    <div class="nice-testimonials-slider-container">
        ...
        <div class="container">
            <div class="owl-carousel nice-testimonials-slider-one">';
        ...
        for ($i = 1; $i <= $testimonialcount; $i++) {
            ...
            if (!empty($this->config->$imagefield) && count($files) >= 1) {
                ...
                $imgsrc = moodle_url::make_file_url(
                    ...
                    "/{$this->context->id}/block_nice_testimonials_slider_1/items/{$i}/{$filename}"
                );
            }
            ...
            $this->content->text .= '
                <div class="nice-testimonial-card-container">
                    <div class="nice-testimonial-card nice-border-radius nice-background-white position-relative">
                        <div class="nice-testimonial-card-image-container d-flex align-items-center">
                            <div class="nice-testimonial-card-image position-relative">
                                <img class="rounded-circle" src="' . $imgsrc . '" alt="' . $name . ' ' . $i . '"/>
                                <div class="nice-testimonial-card-image-overlay position-absolute rounded-circle"></div>
                            </div>
                            <div>
