...
/**
 * Block edit form for block_nice_boxes_3.
 *
...
class block_nice_boxes_3_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_boxes_3')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_boxes_3'),
            1 => get_string('right', 'block_nice_boxes_3'),
            2 => get_string('center', 'block_nice_boxes_3'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_boxes_3'),
            $titleplacementoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_boxes_3')
        );
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            $mform->addElement(
                'header',
                'config_item' . $i,
                get_string('config_item', 'block_nice_boxes_3') . $i
            );
            ...
            $mform->addElement(
                'text',
                'config_title' . $i,
                get_string('config_title', 'block_nice_boxes_3', $i)
            );
            // Set default title for each item.
            $mform->setDefault('config_title' . $i, 'Why Choose Us');
            ...
            $mform->addElement(
                'filemanager',
                'config_image' . $i,
                get_string('config_image', 'block_nice_boxes_3', $i),
                null,
                $filemanageroptions
            );
        }
