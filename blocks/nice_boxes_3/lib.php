...
/**
 * Standard functions for block_nice_boxes_3.
 *
...
function block_nice_boxes_3_pluginfile(
    $course,
    $birecordorcm,
    $context,
    $filearea,
    ...
    if ($context->get_course_context(false)) {
        ...
        if ($parentcontext->contextlevel === CONTEXT_COURSECAT) {
            // Check if the category is visible and if the user can view this category.
