...
/**
 * Class definition for block_nice_courses_slider_3.
 *
 * @package    block_nice_courses_slider_3
 * @copyright  2025 Nice Learning <support@docs.nicelearning.org>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_courses_slider_3 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_courses_slider_3');
    }
    ...
    public function get_content(): stdClass {
        ...
        $viewallcourses = get_string('view_all_courses', 'block_nice_courses_slider_3');
        $people = get_string('people', 'block_nice_courses_slider_3');
        $displaycourses = get_string('display_courses', 'block_nice_courses_slider_3');
            ...
            foreach ($coursesarr as $courseid) {
                ...
                if ($courserecord) {
                    ...
                    if ($categoryrecord && $categoryrecord->visible) {
                        ...
                        $courseobj->category = $categoryrecord->id;
                        $courseobj->category_name = $categoryrecord->name;
        ...
        $hrcontent = '<hr>';
        if (!$this->config->show_shortname && !$this->config->show_students) {
            $hrcontent = '';
        }

        $text = '
            <section class="nice-courses-slider-3">
                <div class="nice-courses-slider-container">
                    ...
                    <div class="container">
                        <div class="owl-carousel nice-courses-slider-three">';
                    ...
                    $text .= '
                        <a href="' . $nicecourse->url . '" class="course-card-link">
                            <div class="nice-course-card-container position-relative">
                                <div class="nice-course-card overflow-hidden nice-border-radius">
                                    ...
                                    <div class="nice-course-card-content-container nice-background-white">
                                        <div class="nice-course-card-title-container">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">'
                                            . $shortnamecontent . $studentscontent . '
                                        </div>';

                    if ($nicecourse->course_price) {
                        $text .= '
                                        <div class="nice-course-card-price-container fw-bold text-center position-absolute nice-border-radius nice-box-shadow nice-background-white">
                                            <div class="nice-course-card-price">
                                                <span>$</span><span>'
                                                    . $nicecourse->course_price . '
                                                </span>
                                            </div>
                                        </div>';
                    }
