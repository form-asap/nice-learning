...
/**
 * Block edit form for block_nice_categories_slider_1.
 *
...
class block_nice_categories_slider_1_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_categories_slider_1')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_categories_slider_1'),
            1 => get_string('right', 'block_nice_categories_slider_1'),
            2 => get_string('center', 'block_nice_categories_slider_1'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_categories_slider_1'),
            $titleplacementoptions
        );
        // Set default value for title placement as "left".
        $mform->setDefault('config_title_placement', 0);

        // Add a text input element to the form for configuring the block description.
        // The label for this element is fetched from the language file associated with your custom block.
        $mform->addElement(
            'textarea',
            'config_main_description',
            get_string('config_main_description', 'block_nice_categories_slider_1')
        );
        // Define the data type for the block description text input.
        ...
        $mform->addElement(
            'select',
            'config_show_count',
            get_string('config_show_count', 'block_nice_categories_slider_1'),
            $showcountoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_description', 'block_nice_categories_slider_1'),
            $showdescriptionoptions
        );
        ...
        $mform->addElement(
            'text',
            'config_link',
            get_string('config_link', 'block_nice_categories_slider_1')
        );
        ...
        $options = [
            'multiple' => true,
            'noselectionstring' => get_string('select_categories', 'block_nice_categories_slider_1'),
        ];
