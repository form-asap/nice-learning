...
/**
 * Block edit form for block_nice_hero_2.
 *
...
class block_nice_hero_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_title',
            get_string('config_title', 'block_nice_hero_2')
        );
        $mform->setDefault(
            'config_title',
        ...
        // Add a dropdown (select element) for "Show Read More Link".
        // The options are Yes and No, represented as 1 and 0 respectively.
        $showreadmoreoptions = [
        ...
        $mform->addElement(
            'select',
            'config_show_read_more',
            get_string('config_show_read_more', 'block_nice_hero_2'),
            $showreadmoreoptions
        );
        $mform->setDefault('config_show_read_more', 0);

        // Add a text input element for "Read More Link".
        $mform->addElement(
            'text',
            'config_read_more_link',
            get_string('config_read_more_link', 'block_nice_hero_2')
        );
        $mform->setType('config_read_more_link', PARAM_URL);
        $mform->setDefault('config_read_more_link', 'https://nicelearning.net/');

        // Add a filemanager element for image upload.
        $mform->addElement(
            'filemanager',
            'config_image',
            get_string('config_image', 'block_nice_hero_2'),
            null,
            [
                'subdirs' => 0,
    ...
    public function set_data($defaults) {
        ...
        file_prepare_draft_area(
            ...
            'block_nice_hero_2', // The component name.
