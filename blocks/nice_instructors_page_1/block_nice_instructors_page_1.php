...
/**
 * Class definition for the block_nice_instructors_page_1
 *
 * @package     block_nice_instructors_page_1
 * @copyright   2025 Nice Learning <support@docs.nicelearning.org>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_instructors_page_1 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_instructors_page_1');
    }
    ...
    public function get_content(): stdClass {
        ...
        $viewallinstructors = get_string('view_all_instructors', 'block_nice_instructors_page_1');
        $chooseitems = get_string('choose_items', 'block_nice_instructors_page_1');
        ...
        $text = '
            <section class="nice-instructors-page-1">
                <div class="nice-instructors-page-container">
                    <div class="container">
                        <div class="nice-instructors-page-title-container">
                            <h2 class="h2 mb-0 fw-bold ' . $alignmentclass . '">'
                                . format_text(
                        ...
                        <div class="nice-instructors-page-description-container">
                            <p class="m-0">'
                                . format_text(
            ...
            foreach ($selectedusers as $user) {
                ...
                $text .= '
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                        <a href="' . $profileurl . '">
                            <div class="nice-instructor-card-container nice-border-radius position-relative">
                                <div class="nice-instructor-card nice-border-radius nice-background-white text-center">
