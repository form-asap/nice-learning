...
/**
 * Class definition for block_nice_boxes_1.
 *
 * @package     block_nice_boxes_1
 * @copyright   2025 Nice Learning <support@docs.nicelearning.org>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_boxes_1 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_boxes_1');
    }
    ...
    public function specialization(): void {
        ...
        if (empty($this->config)) {
            ...
            for ($i = 1; $i <= 3; $i++) {
                ...
                $this->config->$field =
                    $CFG->wwwroot . '/theme/nice/pix/blocks/boxes/nice_box_' . $i . '.png';
            }
            ...
            <div class="boxes-nice-1">
                <div class="nice-boxes-one nice-boxes-container">
                    <div class="container">
                        ...
                        <div class="nice-boxes-description-container">
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            if (!empty($this->config->$image) && count($files) >= 1) {
                ...
                $imgsrc = moodle_url::make_file_url(
                    ...
                    "/{$this->context->id}/block_nice_boxes_1/items/$i/$mainfilename"
                );
            }
            ...
            $this->content->text .= '
                <div class="col-xl-4 col-md-6">
                    <div class="nice-box-container position-relative">
                        <div class="nice-box-image-container text-center nice-color-white rounded-circle position-absolute z-1">
                            <img src="' . $imgsrc . '" alt="' . $title . ' ' . $i . '"/>
                        </div>
                        <div class="nice-box-title-container nice-border-radius position-relative nice-background-white overflow-hidden">
                            <p class="nice-box-title text-center fw-bold m-0">'
                                . $title . '
                            </p>
                        </div>
                    </div>
