...
/**
 * Block edit form for block_nice_boxes_1.
 *
 * @package     block_nice_boxes_1
 * @copyright   2025 Nice Learning <support@docs.nicelearning.org>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

// Extend the block_edit_form class to customize the edit form of the block.
class block_nice_boxes_1_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_boxes_1')
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_boxes_1')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_boxes_1'),
            1 => get_string('right', 'block_nice_boxes_1'),
            2 => get_string('center', 'block_nice_boxes_1'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_boxes_1'),
            $titleplacementoptions
        );
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            $mform->addElement(
                'header',
                'config_item' . $i,
                get_string('config_item', 'block_nice_boxes_1') . $i
            );
            ...
            $mform->addElement(
                'text',
                'config_title' . $i,
                get_string('config_title', 'block_nice_boxes_1', $i)
            );
            // Set default title for each item.
            $mform->setDefault('config_title' . $i, 'test title');
            ...
            $mform->addElement(
                'filemanager',
                'config_image' . $i,
                get_string('config_image', 'block_nice_boxes_1', $i),
                null,
                $filemanageroptions
            );
        }
