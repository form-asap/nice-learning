...
/**
 * Class definition for the block_nice_courses_slider_1.
 *
 * @package    block_nice_courses_slider_1
 * @copyright  2025 Nice Learning <support@docs.nicelearning.org>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_nice_courses_slider_1 extends block_base {
    ...
    public function init(): void {
        $this->title = get_string('pluginname', 'block_nice_courses_slider_1');
    }
    ...
    public function get_content(): stdClass {
        ...
        $viewallcourses = get_string('view_all_courses', 'block_nice_courses_slider_1');
        $people = get_string('people', 'block_nice_courses_slider_1');
        $displaycourses = get_string('display_courses', 'block_nice_courses_slider_1');
        ...
        $text = '
            <section class="nice-courses-slider-1">
                <div class="nice-courses-slider-container">
                    ...
                    <div class="container">
                        <div class="owl-carousel nice-courses-slider-one">';
