...
/**
 * Block edit form for block_nice_courses_slider_1.
 *
...
class block_nice_courses_slider_1_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_courses_slider_1')
        );
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_courses_slider_1'),
            1 => get_string('right', 'block_nice_courses_slider_1'),
            2 => get_string('center', 'block_nice_courses_slider_1'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_courses_slider_1'),
            $titleplacementoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_courses_slider_1')
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_shortname', 'block_nice_courses_slider_1'),
            $showshortnameoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_students', 'block_nice_courses_slider_1'),
            $showstudentsoptions
        );
        $mform->setDefault('config_show_students', 1);

        // Add a text input element for the link URL.
        $mform->addElement(
            'text',
            'config_link',
            get_string('config_link', 'block_nice_courses_slider_1')
        );
        ...
        $options = [
            'multiple' => true,
            'noselectionstring' => get_string('select_courses', 'block_nice_courses_slider_1'),
        ];
        $mform->addElement(
            'course',
            'config_courses',
