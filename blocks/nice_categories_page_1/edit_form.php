...
/**
 * Block edit form for block_nice_categories_page_1.
 *
...
class block_nice_categories_page_1_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_main_title',
            get_string('config_main_title', 'block_nice_categories_page_1')
        );
        ...
        $mform->addElement(
            ...
            get_string('config_main_description', 'block_nice_categories_page_1')
        );
        // Define the data type for the block title text input.
        // In this case, it's set to accept raw data, which means Moodle won't perform any additional cleaning or validation.
        ...
        $titleplacementoptions = [
            0 => get_string('left', 'block_nice_categories_page_1'),
            1 => get_string('right', 'block_nice_categories_page_1'),
            2 => get_string('center', 'block_nice_categories_page_1'),
        ];
        $mform->addElement(
            'select',
            'config_title_placement',
            get_string('config_title_placement', 'block_nice_categories_page_1'),
            $titleplacementoptions
        );
        ...
        $mform->addElement(
            'select',
            'config_show_count',
            get_string('config_show_count', 'block_nice_categories_page_1'),
            $showcountoptions
        );
        ...
        $mform->addElement(
            ...
            get_string('config_show_description', 'block_nice_categories_page_1'),
            $showdescriptionoptions
        );
        ...
        $options = [
            'multiple' => true,
            'noselectionstring' => get_string('select_categories', 'block_nice_categories_page_1'),
        ];
