...
/**
 * Block edit form for block_nice_hero_4.
 *
...
class block_nice_hero_4_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement(
            'text',
            'config_title',
            get_string('config_title', 'block_nice_hero_4')
        );
        $mform->setDefault(
            'config_title',
        ...
        // Add a text input element to the form for configuring the block sub-title.
        $mform->addElement(
            'text',
            'config_sub_title',
            get_string('config_sub_title', 'block_nice_hero_4')
        );
        $mform->setDefault(
            'config_sub_title',
            'Start learning from the world’s best institutions'
        ...
        // Add a filemanager element to the form for uploading and managing images associated with the block.
        $mform->addElement(
            'filemanager',
            'config_image',
            get_string('config_image', 'block_nice_hero_4'),
            null,
            [
                'subdirs' => 0,
    ...
    public function set_data($defaults) {
        ...
        file_prepare_draft_area(
            ...
            'block_nice_hero_4', // The component name.
        ...
        // After setting the data, check if there is data to retrieve from the form.
