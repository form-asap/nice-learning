...
/**
 * Layout file for the login page in theme_nice.
 *
 * @package   theme_nice
...
// Define any extra body CSS classes for the login page.
$extraclasses = ['nice_context_frontend'];
...
echo $OUTPUT->render_from_template('theme_nice/nice_login', $templatecontext);
